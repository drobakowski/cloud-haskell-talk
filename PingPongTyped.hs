...
data JoinChatMessage = JoinChat {   clientName :: String,
                                   clientSPort :: SendPort ChatMessage }
                     deriving (Generic, Typeable, Show)
...
mkJoinChatMessage :: SendPort ChatMessage -> String -> JoinChatMessage
mkJoinChatMessage sport msg = JoinChat {clientSPort = sport, clientName = msg}
